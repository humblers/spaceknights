...
var units = {
	...
	"jouster": {
		...
		"attacktype":    "Melee",
		"damagetype":    "AntiShield",
		"attackdamage":   [300, 70, 100],
		"attackrange":    40,
		"attackinterval": 14,
		"preattackdelay": 5,
		"chargedelay":           20,
		"chargedmovespeed":      300,
		"chargedattackdamage":   [600, 450, 550],
	...
	"panzerkunstler": {
		...
		"attacktype":    "Melee",
		"damagetype":    "NormalDamage",
		"attackdamage":   [700, 70, 100],
		"attackrange":    40,
		"attackinterval": 30,
		"preattackdelay": 15,
		"powerattackdamage":    [1000, 200, 300],
