...
var Units = map[string]Unit{
	...
	"jouster": map[string]interface{}{
		...
		"attacktype":            Melee,
		"damagetype":            AntiShield,
		"attackdamage":          []int{300, 70, 100},
		"attackrange":           40,
		"attackinterval":        14,
		"preattackdelay":        5,
		"chargedelay":           20,
		"chargedmovespeed":      300,
		"chargedattackdamage":   []int{600, 450, 550},
	...
	"panzerkunstler": map[string]interface{}{
		...
		"attacktype":           Melee,
		"damagetype":           NormalDamage,
		"attackdamage":         []int{700, 70, 100},
		"attackrange":          40,
		"attackinterval":       30,
		"preattackdelay":       15,
		"powerattackdamage":    []int{1000, 200, 300},
